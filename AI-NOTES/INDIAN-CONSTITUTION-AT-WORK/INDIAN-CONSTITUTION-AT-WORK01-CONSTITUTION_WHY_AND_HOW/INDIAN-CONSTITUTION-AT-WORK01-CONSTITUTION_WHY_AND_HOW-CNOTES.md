# Indian Constitution at Work | Chapter 01 | Constitution Why and How | CNOTES
...
```mermaid
mindmap
  root((5 Functions of Constitution))
    ((1 Coordination and Assurance))
      ((Basic Rules Publicly Known))
      ((Legally Enforceable))
      ((Assurance to All Citizens))
    ((2 Decision-Making Power))
      ((Who Gets to Decide))
      ((Monarchy vs Democracy vs Direct))
      ((Parliament in India))
    ...
    ((4 Enabling Aspirations))
      ...
      ((Overcome Deep Inequalities))
      ((Preamble DPSP and FR))
    ((5 Collective Identity))
      ((Political Identity))
      ((Moral Identity))
      ((Civic Not Ethnic Citizenship))
```
...
```mermaid
mindmap
  root((What Makes a Constitution Effective))
    (Mode of Promulgation)
      (Who Crafted It)
      (Popular National Movement)
      (Public Credibility of Framers)
      (Broad National Consensus)
    (Substantive Provisions)
      (Everyone Has Reason to Obey)
      (Freedom and Equality Preserved)
      (No Permanent Majority Rule)
...
```mermaid
mindmap
  root((Constituent Assembly of India))
    [Key Dates]
      [9 Dec 1946 First Sitting]
      [14 Aug 1947 For Divided India]
      [26 Nov 1949 Constitution Adopted]
      [24 Jan 1950 Signatures Appended]
      [26 Jan 1950 Constitution in Force]
    [Composition]
      [299 Members after Partition]
      [82 Percent Congress Seats]
      [28 Scheduled Caste Members]
      [All Religions Represented]
    (Cabinet Mission Plan)
      (1 Seat per 10 Lakh Population)
      (292 Province Seats)
      (93 Princely State Seats)
      (Proportional Representation STV)
    [Key Leaders]
      [Ambedkar Drafting Committee Chair]
      [Nehru Objectives Resolution]
      [Rajendra Prasad CA President]
      [Sardar Patel Committees]
```
...
```mermaid
mindmap
  root((Deliberation and Nationalist Inheritance))
    ((Principle of Deliberation))
      ((Whole Nation in Mind))
      ((Principled Not Self-Interest))
      ((Public Reason))
    [Procedures]
      [8 Major Committees]
      [166 Days of Debate]
      [Open to Press and Public]
      [Every Concern in Writing]
    (Nationalist Inheritance)
      (Values from Freedom Struggle)
      (Equality Liberty Democracy)
      (Sovereignty Cosmopolitan Identity)
    ((Universal Suffrage))
      ((Only Undebated Provision))
      ((Self-Evidently Just))
```
...
```mermaid
mindmap
  root((Objectives Resolution 1946))
    (1 Sovereign Republic)
    (2 Union of All Territories)
    (3 Autonomous Units with Powers)
    (4 All Authority Flows from People)
    (5 Social Economic Political Justice)
      (Equality of Status and Opportunity)
      (Fundamental Freedoms)
      (Equality Before Law)
    (6 Safeguards for Minorities)
    (7 Territorial Integrity Maintained)
    (8 Contribution to World Peace)
```
